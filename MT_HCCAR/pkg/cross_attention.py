...
class NLBlockND(nn.Module):
    def __init__(self, in_channels, inter_channels=None, mode='embedded', 
        ...
        if bn_layer:
            ...
            self.W_z = conv_nd(self.inter_channels, self.in_channels)
    ...
    def forward(self, x):
        ...
        if self.mode == "gaussian":
            ...
            phi_x = x1.view(batch_size, self.in_channels, -1)
            ...
            theta_x = self.theta(x2).view(batch_size, self.inter_channels, -1, 1)
            phi_x = self.phi(x1).view(batch_size, self.inter_channels, 1, -1)
